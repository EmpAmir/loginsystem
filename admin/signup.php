...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "select id from users where contact='$contact'");
    $row = mysqli_num_rows($sql);
    if ($row > 0) {
        echo "<script>alert('Contact no already exist with another account. Please try with other contact no');</script>";
    } else {
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h2 text-align="center">Registration and Login System</h2>
                                    <hr />
