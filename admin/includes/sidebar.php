          ...
          <div class="sb-sidenav-menu">
              <div class="nav">
                  ...
                  <a class="nav-link" href="manage-orders.php">
                      <div class="sb-nav-link-icon text-primary"><i class="fas fa-money-check-alt"></i></div>
                      Manage Orders
                  </a>

                  <a class="nav-link" href="bwdates-report-ds.php">
                      <div class="sb-nav-link-icon text-primary"><i class="fa fa-calendar"></i></div>
                      B/w Dates Report
                  </a>

                  <a class="nav-link" href="logout.php">
                      <div class="sb-nav-link-icon text-primary"><i class="fas fa-sign-out-alt"></i></div>
                      Signout
                  </a>
              </div>
          </div>
